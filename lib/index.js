...
// Bare specifier (hoisted by pnpm in the profile node_modules), same as other
// host-plane plugins; a local node_modules symlink keeps it resolvable when the
// package is installed via `link:` from outside the profile tree.
